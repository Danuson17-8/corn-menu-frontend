...
export default function MenuCategoryCard () {
    ...
    return (
        <div className="relative">
            ...
            >
                <ScrollImage progress={scrollYProgress} className="h-[60vh] lg:h-[70vh] mx-auto mt-5" src="/images/new-corn.png"/>
                <motion.div
                ...
                >
                    <div className="flex justify-around mt-20 lg:mt-0 gap-5 lg:gap-120">
                        <ScrollScale progress={scrollYProgress} className="text-5xl lg:text-[130px]">                     
                            <span className="text-black">ME</span><span className="text-white">NU</span>
                            <p className="text-[50px]">SHOP</p>
                        </ScrollScale>
                        <ScrollScale progress={scrollYProgress} className="text-white text-5xl md:text-[100px] mt-60 md:mt-50 lg:mt-20">
