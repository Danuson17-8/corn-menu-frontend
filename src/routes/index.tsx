...
function RouteComponent() {
  ...
  return (
    <div 
      className="text-white py-10 px-5 min-h-screen bg-cover bg-gray-950 select-none"
    ...
    >
      <div className="flex justify-center lg:gap-35 sticky top-30">
        ...
        <Card className="hidden md:block bg-primary h-95 lg:h-125 w-100 border-0 rounded-2xl overflow-hidden group relative transform transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:scale-[1.02]">
          <img
